...
var Timer = function () {
	...
	/* Вешаем на init три события, три нажатия на кнопки */
	...
	/* Конец чтения текущего значения таймера */
	...
	/* Установка таймера. Установка новых значений в documet */
	...
	/* Получаем значение текущего таймера getTime в виде милисекунд */
